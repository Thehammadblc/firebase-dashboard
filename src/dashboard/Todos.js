  ...
  return (
    <div className="space-y-6 md-py-2 md:pt-1 pt-10">
      ...
      <div className="text-center mb-6">
        <h1 className="text-4xl font-semibold text-gray-100">Todo List</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {todos.map((todo) => (
          <Card
            ...
            className={`shadow-lg rounded-xl p-4 transition-all duration-300 ${todo.completed ? 'border-l-4 border-green-500' : 'border-l-4 border-red-500'}`}
          >
      ...
      <Modal
        ...
        visible={isEditing || newTodoTitle !== ""}
        onOk={handleAddOrUpdateTodo}
        onCancel={() => { setIsEditing(false); setEditingTodo(null); setNewTodoTitle(""); }}
        okText={isEditing ? "Update" : "Add"}
        cancelText="Cancel"
        okButtonProps={{ disabled: !newTodoTitle.trim() }}
      >
        <Input
          value={newTodoTitle}
          onChange={(e) => setNewTodoTitle(e.target.value)}
